...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # .inject performs a block on a given array. Two values are passed in as arguments, one of which is a return value that overwrites the original value.
  end
  ...
  #The bottome option doesn't close the file. Perhaps it has something to do with being able to write to it, too.
